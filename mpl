...
<title>
    The Tribute | Dr.  A.P.J abdul kalam
</title>
<body>
   .container{
       background-color: rgb(87, 151, 184);
       height: 1600px;
       border: 20px solid rgb(156, 20, 20);
    ...
    <div class="container">
        <div class="content">            
            <section class="top_section"> 
                <img src="images/pngegg.png" alt="tribute" height="300px" width="300px"/>     
                       <div>   
